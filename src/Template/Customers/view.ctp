      ...
      <div class="box box-solid">
        ...
        <div class="box-body">
          <dl class="dl-horizontal">
            ...
            <dd><?= h($customer->full_name) ?></dd>
            <dt scope="row"><?= __('Phone Number') ?></dt>
            <dd><?= h($customer->phone_number) ?></dd>
            <dt scope="row"><?= __('Email') ?></dt>
            <dd><?= h($customer->email) ?></dd>
            <dt scope="row"><?= __('Address') ?></dt>
            <dd><?= h($customer->address) ?></dd>
            <dt scope="row"><?= __('Id') ?></dt>
            <dd><?= $this->Number->format($customer->id) ?></dd>
            <dt scope="row"><?= __('Birthday') ?></dt>
            <dd><?= h($customer->birthday) ?></dd>
            <dt scope="row"><?= __('Wedding Anniversary') ?></dt>
            <dd><?= h($customer->wedding_anniversary) ?></dd>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-solid">
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <?php if (!empty($customer->laundry_requests)): ?>
          <table class="table table-hover">
              ...
              <?php foreach ($customer->laundry_requests as $laundryRequests): ?>
              <tr>
