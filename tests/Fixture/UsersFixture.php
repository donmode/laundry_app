...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone_number' => ['type' => 'string', 'length' => 15, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'users_UNIQUE_PHONENUMBER' => ['type' => 'unique', 'columns' => ['phone_number'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2020-06-26 15:34:59',
                'modified' => '2020-06-26 15:34:59',
            ],
        ];
        parent::init();
    }
