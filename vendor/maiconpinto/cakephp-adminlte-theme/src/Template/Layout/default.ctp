    ...
    <body class="hold-transition skin-<?php echo Configure::read('Theme.skin'); ?> sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a style="background-color: white; color: red;" href="<?php
                echo
// $this->Url->build('/')
                $this->Url->build(array('plugin' => false, 'controller' => 'users', 'action' => 'login'));
                ?>" class="logo"  >
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span style="margin: -2px 0 1px 0;" class="logo-mini"><?php echo Configure::read('Theme.logo.mini'); ?></span>
                    <!-- logo for regular state and mobile devices -->
                    <span style="margin: -2px 0 1px 0;" class="logo-lg"><?php echo Configure::read('Theme.logo.large'); ?></span>
                </a>
