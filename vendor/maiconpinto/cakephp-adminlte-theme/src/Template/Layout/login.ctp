...
<body class="hold-transition login-page" style="background-color: snow;">
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo $this->Url->build('/'); ?>"><?php echo Configure::read('Theme.logo.login'); ?></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php // if (Configure::read('Theme.login.show_remember')): ?>
      <!--<a href="#">Register a Company</a><br>-->
    <?php // endif; ?>
