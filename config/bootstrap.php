...
Configure::write('Theme', [
    'title' => 'Laundry App',
    'logo' => [
        'large' => '<div style="background-color: white; color: red;"><img src="/img/laundry_logo.png" /><br><strong style="margin-left:4px;">Laundry App</strong></div>',
        'mini' => '<div style="background-color: white; color: red;"><img src="/img/laundry_mini_logo.png" /><br><strong style="margin-left:4px;">Laundry App</strong></div>',
        'login' => '<div><img src="/img/laundry_logo.png" /><br><strong style="color: red;">Laundry App</strong></div>'
    ],
    'login' => [
        'show_remember' => false,
        'show_register' => FALSE,
